...
def get_data(url):    
    ...
    try:
        ...
        print('Error:')
        print(e)
#print(get_data('https://scontent-iad3-1.xx.fbcdn.net/v/t1.0-9/15327224_10206110928250803_8293451196937616712_n.jpg?oh=925c3fc18c2d36679a4e1c558abce5bb&oe=5B184B15'))
'''
x = 0
y = 20
for j in range(20):
